 ...
 * TeamLeader Class
 */
public class TeamLeader extends EmployeeBoss {
	...
	public void read(ObjectInputStream in) throws FileNotFoundException, IOException, 
		...
		super.read(in, EmployeeNormal.class.getName()); // super
	}
	...
	public void print() {
		...
		System.out.println("---Team Leader"); // team leader
	...
	public void append(Employee employee) throws ClassNotFoundException, 
		...
		this.subs.add((EmployeeNormal)Factory.getInstance(employee.getClass().getName())); // add sub
