 ...
 * Manager Class
 */
public class Manager extends EmployeeBoss {
	...
	public void read(ObjectInputStream in) throws FileNotFoundException, IOException, 
		...
		super.read(in, GroupLeader.class.getName()); // super
	}
	...
	public void append(Employee employee) throws ClassNotFoundException, 
		...
		this.subs.add((GroupLeader)Factory.getInstance(employee.getClass().getName())); // add sub
